...
<?php
 ...
 $consulta="SELECT*FROM ropa WHERE `id-ropa`=1";
        ...
        <div class="row py-3 justify-content-center align-items-center my-3" style="background: linear-gradient(to bottom, #660033 0%, #003300 100%);">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="row">
                    ...
                    <div class="col-4 col-sm-4">
                        <div class="row p-2">
                            <a class="text-warning text-center text-decoration-none rounded-circle" href="login.html">Ingresá <br><i class="material-icons px-3">login</i></a>
                        </div>
                    </div>
